...
<div class="mt-8">
    ...
    .then(data => {
        ...
        document.querySelector('p#totalCases').textContent = data.stats.total;
        document.querySelector('p#activeCases').textContent = data.stats.active;
        document.querySelector('p#closedCases').textContent = data.stats.closed;
        document.querySelector('p#avgResolution').textContent = data.stats.avg_resolution + ' days';
