    ...
    <section class="container mx-auto mt-10 px-4">
        <div class="gradient-bg rounded-2xl shadow-sm p-8 md:p-12 relative overflow-hidden">
            ...
            <div class="relative z-10">
                <h2 class="text-3xl font-light text-primary-800">Welcome, <span class="font-medium">Barangay Official - Captain</span></h2>
    ...
    <div class="container mx-auto mt-8 px-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <a href="view_cases.php" class="card-hover flex items-center p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
                ...
                <div>
                    <h4 class="font-medium text-gray-800">View and Assign Cases</h4>
                    <p class="text-sm text-gray-500">Monitor assignment of cases</p>
                </div>
            </a>
