...
<body class="bg-gray-50 font-sans">    <?php include_once('../includes/resident_nav.php'); ?>    <!-- Page Header -->
    <div class="w-full mt-10 px-4">
        <div class="gradient-bg rounded-2xl shadow-sm p-8 md:p-10 relative overflow-hidden">
            ...
            <div class="relative z-10 flex justify-between items-center">
                <div>
                    <h2 class="text-3xl font-light text-primary-800">Legal <span class="font-medium">Cases</span></h2>
                    <p class="mt-3 text-gray-600 max-w-md">View and track the status of all cases involving you at the barangay level.</p>
                </div>
                <div class="hidden md:flex space-x-2">
                    ...
                    <span class="px-3 py-1 bg-yellow-100 text-yellow-700 rounded-full text-sm font-medium flex items-center">
                        <span class="w-2 h-2 bg-yellow-500 rounded-full mr-2"></span> Pending: 2
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-4">
            <div class="flex flex-wrap justify-between items-center">
                <div class="flex flex-wrap items-center gap-2 mb-2 md:mb-0">
                    <button class="px-3 py-1 bg-primary-50 text-primary-700 rounded-lg text-sm font-medium border border-primary-100">All Cases</button>
                    <button class="px-3 py-1 text-gray-500 rounded-lg text-sm hover:bg-gray-50">Pending</button>
                    <button class="px-3 py-1 text-gray-500 rounded-lg text-sm hover:bg-gray-50">Mediation</button>
                ...
                <table class="w-full">
                    <thead>
                        <tr class="bg-gray-50 text-left">
                            <th class="py-4 px-6 text-sm font-medium text-gray-600">Case ID</th>
                            <th class="py-4 px-6 text-sm font-medium text-gray-600">Type</th>
                            <th class="py-4 px-6 text-sm font-medium text-gray-600">Filed Date</th>
                            <th class="py-4 px-6 text-sm font-medium text-gray-600">Next Hearing</th>
                    ...
                    <tbody>
                        <tr class="border-t border-gray-100 table-row">
                            <td class="py-4 px-6 text-sm">CASE-001</td>
                            <td class="py-4 px-6 text-sm font-medium">Property Dispute</td>
                            <td class="py-4 px-6 text-sm text-gray-500">May 1, 2025</td>
                            <td class="py-4 px-6 text-sm text-gray-500">May 20, 2025</td>
                            <td class="py-4 px-6">
                            ...
                            <td class="py-4 px-6">
                                <button class="view-case-btn px-3 py-1 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center" data-id="CASE-001">
                                    <i class="fas fa-eye mr-1"></i> View Details
                                </button>
                            </td>
                        </tr>
                        <tr class="border-t border-gray-100 table-row">
                            <td class="py-4 px-6 text-sm">CASE-002</td>
                            <td class="py-4 px-6 text-sm font-medium">Noise Complaint</td>
                            <td class="py-4 px-6 text-sm text-gray-500">Apr 15, 2025</td>
                            <td class="py-4 px-6 text-sm text-gray-500">N/A</td>
                            <td class="py-4 px-6">
                            ...
                            <td class="py-4 px-6">
                                <button class="view-case-btn px-3 py-1 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center" data-id="CASE-002">
                                    <i class="fas fa-eye mr-1"></i> View Details
                                </button>
                            </td>
                        </tr>
                        <tr class="border-t border-gray-100 table-row">
                            <td class="py-4 px-6 text-sm">CASE-003</td>
                            <td class="py-4 px-6 text-sm font-medium">Boundary Dispute</td>
                            <td class="py-4 px-6 text-sm text-gray-500">May 8, 2025</td>
                            <td class="py-4 px-6 text-sm text-gray-500">May 18, 2025</td>
                            <td class="py-4 px-6">
                                <span class="px-3 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium status-badge">
                                    Mediation
                                </span>
                            </td>
                            <td class="py-4 px-6">
                                <button class="view-case-btn px-3 py-1 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center" data-id="CASE-003">
                                    <i class="fas fa-eye mr-1"></i> View Details
                                </button>
                            </td>
                        </tr>
            ...
            <div class="md:hidden divide-y divide-gray-100">
                ...
                <div class="p-4 space-y-2">
                    <div class="flex justify-between items-center">
                        <span class="text-xs font-medium text-gray-500">CASE-001</span>
                        <span class="px-2 py-1 bg-yellow-100 text-yellow-700 rounded-full text-xs font-medium">
                            Pending
                        </span>
                    </div>
                    <h3 class="font-medium">Property Dispute</h3>
                    <div class="flex justify-between text-sm text-gray-500">
                        <p>Filed: May 1, 2025</p>
                        <p>Hearing: May 20, 2025</p>
                    </div>
                    <div class="pt-2">
                        <button class="view-case-btn w-full px-3 py-2 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center justify-center" data-id="CASE-001">
                ...
                <div class="p-4 space-y-2">
                    <div class="flex justify-between items-center">
                        <span class="text-xs font-medium text-gray-500">CASE-002</span>
                    ...
                    <div class="flex justify-between text-sm text-gray-500">
                        <p>Filed: Apr 15, 2025</p>
                        <p>Resolved: Apr 30, 2025</p>
                    </div>
                    <div class="pt-2">
                        <button class="view-case-btn w-full px-3 py-2 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center justify-center" data-id="CASE-002">
                            <i class="fas fa-eye mr-2"></i> View Details
                        </button>
                    </div>
                </div>
                ...
                <div class="p-4 space-y-2">
                    <div class="flex justify-between items-center">
                        <span class="text-xs font-medium text-gray-500">CASE-003</span>
                        <span class="px-2 py-1 bg-purple-100 text-purple-700 rounded-full text-xs font-medium">
                            Mediation
                        </span>
                    </div>
                    <h3 class="font-medium">Boundary Dispute</h3>
                    <div class="flex justify-between text-sm text-gray-500">
                        <p>Filed: May 8, 2025</p>
                        <p>Mediation: May 18, 2025</p>
                    </div>
                    <div class="pt-2">
                        <button class="view-case-btn w-full px-3 py-2 bg-primary-50 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-100 transition-colors flex items-center justify-center" data-id="CASE-003">
                            <i class="fas fa-eye mr-2"></i> View Details
                        </button>
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
                ...
                button.addEventListener('click', function() {
                    ...
                    if (caseId === 'CASE-001') {
                        ...
                        caseDetails = {
                            ...
                            hearingDate: 'May 18, 2025',
                            description: 'Dispute regarding property boundaries between adjacent lots. Complainant claims encroachment.',
                            nextSteps: 'Mediation session scheduled on May 18, 2025 at 2:00 PM.',
                            timeline: [
                                { date: 'May 8, 2025', event: 'Case filed', status: 'Completed' },
                                { date: 'May 10, 2025', event: 'Notice served to respondent', status: 'Completed' },
                                { date: 'May 18, 2025', event: 'Mediation session', status: 'Scheduled' },
                                { date: 'TBD', event: 'Resolution', status: 'Pending' }
                            ]
                        };
                    }
                    ...
                    const modal = createCaseModal(caseDetails);
            ...
            function createCaseModal(caseDetails) {
                const modal = document.createElement('div');
                modal.innerHTML = `
                    <div class="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center p-4 z-50 transition-opacity duration-300 opacity-0 overflow-y-auto">
                        <div class="bg-white rounded-xl shadow-xl max-w-3xl w-full transform transition-transform duration-300 scale-95 my-8">
                            <div class="border-b border-gray-100 px-6 py-4 flex justify-between items-center sticky top-0 bg-white rounded-t-xl z-10">
                                <h3 class="font-medium text-lg">Case Details</h3>
                                <button aria-label="Close" class="text-gray-400 hover:text-gray-600 p-2">
                            ...
                            <div class="p-6 space-y-8 max-h-[70vh] overflow-y-auto">
                                ...
                                <div class="flex flex-wrap justify-between items-start gap-4 pb-4 border-b border-gray-100">
                                    <div>
                                        <div class="flex items-center gap-2">
                                            <p class="text-sm text-gray-500">${caseDetails.id}</p>
                                            <span class="px-3 py-1 ${getStatusClass(caseDetails.status)} rounded-full text-xs font-medium">
                                                ${caseDetails.status}
                                            </span>
                                        </div>
                                        <h2 class="text-xl font-medium mt-1">${caseDetails.type}</h2>
                                    </div>
                                    <div class="text-right">
                                        <p class="text-sm text-gray-500">Filed On</p>
                                        <p class="font-medium">${caseDetails.filedDate}</p>
                                    </div>
                                </div>
                                
                                <!-- Case Information -->
                                <div>
                                    <h4 class="text-sm font-medium text-gray-700 mb-3">Case Information</h4>
                                    <div class="bg-gray-50 rounded-xl p-4 space-y-4">
                                        <div>
                                            <p class="text-xs text-gray-500">Description</p>
                                            <p class="text-sm mt-1">${caseDetails.description}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Hearing Date</p>
                                            <p class="text-sm font-medium">${caseDetails.hearingDate}</p>
                                        </div>
                                        <div>
                                            <p class="text-xs text-gray-500">Next Steps</p>
                                            <p class="text-sm mt-1">${caseDetails.nextSteps}</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <!-- Involved Parties -->
                                <div>
                                    <h4 class="text-sm font-medium text-gray-700 mb-3">Involved Parties</h4>
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        ${caseDetails.parties.map(party => `
                                            <div class="bg-gray-50 rounded-xl p-4">
                                                <p class="text-xs text-gray-500">${party.role}</p>
                                                <p class="font-medium ${party.name.includes('(You)') ? 'text-primary-700' : ''}">${party.name}</p>
                                            </div>
                                        `).join('')}
                                    </div>
                                </div>
                                ...
                                <!-- Timeline -->
                                <div>
                                    <h4 class="text-sm font-medium text-gray-700 mb-3">Case Timeline</h4>
                                    <div class="space-y-4 relative">
                                        ${caseDetails.timeline.map((event, index) => `
                                            <div class="pl-8 relative timeline-dot">
                                                <div class="absolute left-0 top-0 w-4 h-4 rounded-full ${getStatusDotClass(event.status)} flex items-center justify-center">
                                                    ${event.status === 'Completed' ? '<i class="fas fa-check text-[8px]"></i>' : ''}
                                                </div>
                                                <p class="text-sm font-medium">${event.event}</p>
                                                <div class="flex justify-between items-center">
                                                    <p class="text-xs text-gray-500">${event.date}</p>
                                                    <span class="text-xs ${getStatusTextClass(event.status)}">${event.status}</span>
                                                </div>
                                            </div>
                                        `).join('')}
                                    </div>
                                ...
                                <div>
                                    <h4 class="text-sm font-medium text-gray-700 mb-3">Resolution</h4>
                                    <div class="bg-green-50 rounded-xl p-4 border border-green-100">
                                        <div class="flex items-center mb-2">
                                            <i class="fas fa-check-circle text-green-500 mr-2"></i>
                                            <p class="font-medium text-green-700">Resolved on April 30, 2025</p>
                                        </div>
                                        <p class="text-sm">Both parties have reached an agreement. The respondent has agreed to minimize noise after 10 PM and the complainant has withdrawn the complaint.</p>
                                    </div>
                                </div>
                                ` : ''}
                            </div>
                            
                            <div class="border-t border-gray-100 px-6 py-4 flex flex-wrap gap-3 justify-between items-center sticky bottom-0 bg-white rounded-b-xl">
                                <div class="text-xs text-gray-500">
                                    <i class="fas fa-info-circle mr-1"></i> 
                                    This information is updated as of May 13, 2025
                                </div>
                                <div class="flex gap-3">
                                    ${caseDetails.status !== 'Resolved' ? `
                                    <button class="px-4 py-2 bg-white border border-primary-200 text-primary-600 rounded-lg text-sm font-medium hover:bg-primary-50 transition-colors">
                                        <i class="fas fa-calendar-alt mr-1"></i> View Hearing Schedule
                                    </button>
                                    ` : ''}
                                    <button aria-label="Close" class="px-4 py-2 bg-primary-600 text-white rounded-lg text-sm font-medium hover:bg-primary-700 transition-colors">
                                        Close
                                    </button>
                                </div>
                            </div>
