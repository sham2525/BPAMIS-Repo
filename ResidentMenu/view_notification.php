...
// Fetch notification (match secretary logic for parity)
...
// Mark as read (keeping simple like secretary version)
$conn->query("UPDATE notifications SET is_read = 1 WHERE notification_id = $notificationId");

// Complaint reference (support both naming conventions)
$complaint = null;
