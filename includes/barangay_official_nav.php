<?php
/**
 * Navigation bar component for Barangay Officials
 * Part of the Barangay Panducot Adjudication Management Information System
 */
?>
<!-- Navigation Bar -->
<nav class="bg-white/95 backdrop-blur-md border-b border-blue-50 py-3 px-5 shadow-sm flex justify-between items-center sticky top-0 z-50">
    ...
    <div class="hidden md:block mx-auto">
        <ul class="flex items-center space-x-6">
            <li>
                <a href="home.php" class="tooltip relative group flex items-center justify-center p-3 rounded-full hover:bg-blue-50 transition-all duration-300" data-tooltip="Home">
    ...
    <div class="flex items-center space-x-5">
        ...
        <div class="tooltip relative group">
            <a href="#" class="relative group flex items-center justify-center p-3 rounded-full hover:bg-blue-50 transition-all duration-300" data-tooltip="Notifications">
                <div class="relative">
