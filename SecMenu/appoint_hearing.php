    ...
    if ($stmt->execute()) {
        ...
        if (isset($_SESSION['lupon_name'])) {
            ...
            $checkSql = "
                ...
                LEFT JOIN resolution r ON r.case_id = ci.case_id AND r.mediator_name = ?
                LEFT JOIN settlement s ON s.case_id = ci.case_id AND s.mediator_name = ?
                WHERE ci.case_id = ?
            ...
            if ($checkResult && $checkResult->num_rows > 0) {
                ...
                $luponQuery->execute();
                $luponRes = $luponQuery->get_result();
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <select id="case-id" name="case_id" class="input-base" required>
                            ...
                            <?php
                            $sql = "SELECT ci.Case_ID, co.Complaint_Title FROM case_info ci JOIN complaint_info co ON ci.Complaint_ID = co.Complaint_ID";
