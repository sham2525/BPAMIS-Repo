...
<body class="bg-gray-50 font-sans">
    <?php include '../includes/barangay_official_nav.php'; ?><!-- Page Header -->
        ...
        <div class="bg-white rounded-xl border border-gray-100 shadow-sm p-6">        
            <div class="mb-6 flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <div class="relative w-full md:w-1/2">
                    <input type="text" placeholder="Search complaints..." class="w-full p-3 pl-10 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-300">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="add_complaints.php" class="card-hover flex items-center bg-primary-500 text-white py-3 px-4 rounded-lg hover:bg-primary-600 transition">
          ...
          <div class="overflow-x-auto">
            <table class="w-full mt-4">
                <thead>
                    <tr>
                        <th class="p-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b-2 border-gray-100">Complaint ID</th>
                        ...
                        <th class="p-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-b-2 border-gray-100">Complaint Title</th>
            ...
            <tbody>
                ...
                $sampleComplaints = [
                  ...
                  foreach ($sampleComplaints as $complaint) {
                    ...
                    echo '<td class="p-3 text-sm text-gray-700">' . $complaint['id'] . '</td>';
                    echo '<td class="p-3 text-sm text-gray-700">' . $complaint['complainant'] . '</td>';
                    echo '<td class="p-3 text-sm text-gray-700">' . $complaint['respondent'] . '</td>';
                    echo '<td class="p-3 text-sm text-gray-700">' . $complaint['title'] . '</td>';
                    ...
                    echo '<td class="p-3 text-center">
                            <div class="flex justify-center gap-2">
                                <a href="view_complaint_details.php?id=' . $complaint['id'] . '" class="text-primary-600 hover:text-primary-800 transition p-1">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="edit_complaint.php?id=' . $complaint['id'] . '" class="text-yellow-600 hover:text-yellow-800 transition p-1">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <button class="text-red-600 hover:text-red-800 transition p-1">
        ...
        <div class="chatbot-body" id="chatbotBody">
            ...
            <div class="chat-message bot-message">
                ...
                <div class="message-content">
                    Hi there! I'm your Case Assistant. How can I help you with managing complaints today?
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Simple bot response function for complaint management
            function getBotResponse(message) {
                message = message.toLowerCase();
                
                if (message.includes('hello') || message.includes('hi') || message.includes('hey')) {
                    return 'Hello! How can I assist you with complaint management today?';
                }
                else if (message.includes('status') || message.includes('filter')) {
                    return 'You can filter complaints by status using the dropdown menu at the top of the table. Available statuses include Pending, Under Investigation, Mediation, Resolved, and Dismissed.';
                }
                else if (message.includes('search') || message.includes('find')) {
                    return 'Use the search box above the table to search for specific complaints by complainant name, respondent name, or complaint details.';
                }
                else if (message.includes('edit') || message.includes('update')) {
                    return 'To edit a complaint, click on the edit icon (pencil) in the Actions column for the complaint you wish to modify.';
                }
                else if (message.includes('view') || message.includes('details')) {
                    return 'To view complete details of a complaint, click on the view icon (eye) in the Actions column for the specific complaint.';
                }
                else if (message.includes('print') || message.includes('pdf') || message.includes('export')) {
                    return 'To generate a PDF report of a complaint, click on the PDF icon (red document) in the Actions column.';
                }
                else if (message.includes('add') || message.includes('new') || message.includes('create')) {
                    return 'To add a new complaint, click on the "Add New Complaint" button at the top right of the page.';
                }
                else if (message.includes('thank')) {
                    return 'You\'re welcome! Is there anything else I can help you with regarding complaint management?';
                }
                else {
                    return 'I can help you with managing complaints. You can ask about searching, filtering, viewing details, editing, or creating new complaints.';
                }
            }
        });
    </script>
